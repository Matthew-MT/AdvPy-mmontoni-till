...
def test():
    unittest.TestCase("runTest").assertEqual(algorithm("My words will be counted"), 401)
    unittest.TestCase("runTest").assertEqual(algorithm("Can you count me?"), 271)
    unittest.TestCase("runTest").assertEqual(algorithm("I have the biggest count of them ALL"), 586)
